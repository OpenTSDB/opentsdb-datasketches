...
/**
 * Plugin that handles encoding/decoding {@link CompactDoublesSketch}. 
 * 
 * @since 2.4
 */
public class CompactQuantilesSketchCodec extends HistogramDataPointCodec {
  ...
  public Histogram decode(final byte[] raw_data, final boolean includes_id) {
    ...
    final CompactQuantilesSketchHistogram histogram = 
